...
history = rbm_model.fit(X_train, X_train, epochs=20, batch_size=32, validation_data=(X_test, X_test))
...
confusion_matrix_df.to_csv('confusion_matrix_dbn_kdd.csv', index=False)
